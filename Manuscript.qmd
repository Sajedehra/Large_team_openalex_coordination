...
author-note:
  disclosure:
    data-sharing: "Codes and materials to recreate this manuscript is available at https://github.com/Sajedehra/Large_team_openalex_coordination. Data used in this study is available at https://doi.org/10.4121/28e374ba-3e71-4e42-ae83-00714f5d5161."
...
Overall, bigger teams receive more citations ($\rho$ = `r rho1`, CI = \[`r ci_full$ci.l[1]`, `r ci_full$ci.u[1]`\]) [^3]. This relationship is slightly stronger for the second-year citation count ($\rho$ = `r rho2`, CI = \[`r ci_full$ci.l[2]`, `r ci_full$ci.u[2]`\]) and slightly stronger for publication-date–corrected citation count ($\rho$ = `r rho3`, CI = \[`r ci_full$ci.l[3]`, `r ci_full$ci.u[3]`\]). Analyzing papers in bins of 10 authors, the median and mean of the second-year citation counts increased fairly consistently up to the 45-author group followed by many fluctuations (see @fig-des-citation). Papers with 4 authors receives `r des$citation_2y_mean[9] - des$citation_2y_mean[4]` in mean an `r des$citation_2y_median[9] - des$citation_2y_median[4]` in median lower citation in the first two year than papers with 36-45 authors. This suggests that projects with larger author groups have a relatively large immediate impact, as would be expected when researchers in a field come together to study a topic they all believe should be addressed at this time.
...
The rank correlation between number of authors and SJR value ($\rho$ = `r rho4`, CI = \[`r ci_full$ci.l[4]`, `r ci_full$ci.u[4]`\]) is smaller than the correlation with citation count reported above. Here papers with 4 authors appear in journals with `r des2$SJR_mean[9] - des2$SJR_mean[4]` lower rank score compared to papers with 36-45 authors, and this value for the meadian rank score is `r des2$SJR_median[9] - des2$SJR_median[4]`. @fig-des-journal shows that mean and median SJR value increase consistently until the 46-55 authors bin, then fluctuate for larger groups.
...
The authors declare that the generative AI was only used to increase the efficiency of the code and enhancing the readability of some sentences and in this manuscript

###  Data, code, and materials

Codes and materials to recreate this manuscript is available at https://github.com/Sajedehra/Large_team_openalex_coordination. Data used in this study is available at https://doi.org/10.4121/28e374ba-3e71-4e42-ae83-00714f5d5161.
