...
saveRDS(bigauthor_performance_5, here("data","author_smallvsbig_performance_citation_metrics_20.rds"))
...
wilcox.test(bigauthor_performance_5$citation_median_big, bigauthor_performance_5$citation_median_small, alternative = "greater", conf.int = TRUE)

wilcox.test(bigauthor_performance_5$citation_2y_median_big, bigauthor_performance_5$citation_2y_median_small, alternative = "greater",conf.int = TRUE)

wilcox.test(bigauthor_performance_5$corr_citation_median_big, bigauthor_performance_5$corr_citation_median_small, alternative = "greater", conf.int = TRUE)
...
saveRDS(bigauthor_performance_sjr5, here("data","author_smallvsbig_performance_journal_ranking_20.rds"))
